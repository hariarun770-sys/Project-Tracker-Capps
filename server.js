...
const server = http.createServer((req, res) => {
  ...
  fs.stat(filePath, (err, stats) => {
    if (err || !stats.isFile()) {
      ...
      res.end(`<!DOCTYPE html><html><head><title>404 Not Found</title></head><body style="font-family:sans-serif;padding:40px;text-align:center;"><h1>404 Not Found</h1><p>The requested document <code>${reqUrl}</code> could not be found.</p><p><a href="/" style="color:#2563eb;font-weight:bold;">← Return to Project Tracker Dashboard</a></p></body></html>`);
      return;
    }
